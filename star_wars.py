...
def texto_final():
    ...
    pantalla.blit(mi_fuente_final, (200, 290))
...
while se_ejecuta:
    ...
    # mantener dentro de los bordes al enemigo
        if enemigo_x[e] <= 0:
            ...
            enemigo_y[e] += enemigo_y_cambio[e]       # esto genera que cambie de direcc hacia la der
        elif enemigo_x[e] >= 736:
            enemigo_x_cambio[e] = -0.5
            enemigo_y[e] += enemigo_y_cambio[e]       # esto genera que cambie de direcc hacia la izq
        ...
        if colision:
            ...
            bala_y = 500
            bala_visible = False  # esto genera que la bala se pueda disparar nuevamente
            puntaje += 1
